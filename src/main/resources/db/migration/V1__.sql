...
ALTER TABLE users_user_roles
    ADD CONSTRAINT fk_useuserol_on_role FOREIGN KEY (user_roles_id) REFERENCES `role` (id);

ALTER TABLE users_user_roles
    ADD CONSTRAINT fk_useuserol_on_user FOREIGN KEY (users_id) REFERENCES users (id);